...
*** =M-q= で =tnoda/text-adjust-and-fill-paragraph=                   :key:
#+BEGIN_SRC emacs-lisp :tangle yes
  (require 'text-adjust)
  (defun tnoda/text-adjust-and-fill-paragraph ()
    (interactive)
    (call-interactively 'text-adjust)
    (call-interactively 'fill-paragraph))
  (global-set-key (kbd "M-q") 'tnoda/text-adjust-and-fill-paragraph)
#+END_SRC
...
* Org Mode                                                              :git:
** Git のサブモジュールになっている > git://orgmode.org/org-mode.git
