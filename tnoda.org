...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (add-hook 'inferior-lisp-mode-hook 'tnoda/setup-slime-repl-paredit)
...
+ =ghc*.el= のコンパイルとインストール
  #+BEGIN_SRC sh :tangle install-ghc-mod.sh :var emacs=emacs-app elisp_dir=tnoda-elisp-dir
    ...
    cabal install hlint
    make -C ~/Library/Haskell/ghc-7.0.4/lib/ghc-mod-1.10.15/share EMACS=$emacs
    mkdir -p $elisp_dir/ghc-mod
    cp ~/Library/Haskell/ghc-7.0.4/lib/ghc-mod-1.10.15/share/*.elc $elisp_dir/ghc-mod
  #+END_SRC
