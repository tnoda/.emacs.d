...
#+BEGIN_SRC emacs-lisp :tangle yes
  (el-get 'sync '(ruby-mode ruby-end inf-ruby yari flymake-easy flymake-ruby))
  (require 'ruby-mode)
  (require 'ruby-end)
  (require 'inf-ruby)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (define-key go-mode-map (kbd "<f1>") 'godoc)
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (el-get 'sync '(helm helm-ag helm-project))
  ...
  (define-key helm-command-map (kbd "f") 'helm-project)
